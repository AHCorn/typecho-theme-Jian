 ...
 <?php $this->comments()->to($comments); ?>
    <?php if ($comments->have()): ?>
        <div class="comments-title-box">
            ...
            <span class="comments-title"><?php $this->commentsNum(_t('评论区')); ?></span>
        </div>
    ...
    <div id="<?php $this->respondId(); ?>" class="respond">
    	...
    	<form method="post" action="<?php $this->commentUrl() ?>" id="comment-form" role="form">
    		...
    		<p>
    			<input type="email" name="mail" id="mail" class="text" value="<?php $this->remember('mail'); ?>"<?php if ($this->options->commentsRequireMail): ?> required<?php endif; ?> placeholder="邮箱<?php if ($this->options->commentsRequireMail): ?> 必填<?php endif; ?>） "/>
    		</p>
    		<p>
